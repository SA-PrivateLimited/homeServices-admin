...
exports.sendPushNotification = exports.onPrescriptionCreated = exports.notifyDoctorJoined = exports.updateDoctorStats = exports.sendConsultationReminder = exports.onConsultationBooked = void 0;
...
exports.sendPushNotification = functions.https.onCall(async (data, context) => {
    ...
    try {
        const message = {
            ...
            data: Object.assign(Object.assign({}, notificationData), Object.keys(notificationData || {}).reduce((acc, key) => {
