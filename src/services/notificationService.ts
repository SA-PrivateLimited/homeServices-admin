...
class NotificationService {
  constructor() {
    ...
    if (Platform.OS === 'android') {
      // Check if native module is available before creating channels
      if (!PushNotification || typeof PushNotification.createChannel !== 'function') {
        console.warn('PushNotification native module not available, skipping channel creation');
        return;
      }
      ...
      try {
        ...
        console.warn('Failed to create general-reminders channel:', error);
      }
      ...
      try {
        ...
        console.warn('Failed to create chat-messages channel:', error);
      }
